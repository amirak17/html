    ...
    var tr = document.createElement('tr');
      ...
      var td = document.createElement('td');
           ...
           var logo = document.createElement('span');
                      ...
                      logo.appendChild(document.createTextNode("GTAWebDevelopers Arabic keyboard  "));
                      logo.title = "GTAWebDevelopers.com";
                      logo.onmousedown = function() { this.className = "pressed"; };
                      logo.onmouseup = function() { this.className = ""; };          
          		logo.onclick = function () { location.href='https://gtawebdevelopers.com';}; 
          td.appendChild(logo);
